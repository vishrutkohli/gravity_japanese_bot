...
def greeting_text():
    ...
    response_object =   {
         "setting_type":"greeting",
             "greeting":{
             "text":"Hi {{user_first_name}}! Welcome to the prototype version of DHL Chat Bot. This bot has price data scraped from dhl website(https://parcel.dhl.co.uk/dhl-service-point/size-and-price-guide) and will extract specific data using context like country name from addresses, users name for exact quotation giving and conversation training purposes."
                }
            }
